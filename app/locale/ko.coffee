...
#    None: "None"
  ...
  signup:
    complete_subscription: "가입 완료"
    create_student_header: "학생 계정 만들기"
    create_teacher_header: "선생님 계정 만들기"
    create_individual_header: "개인 계정 만들기"
    email_announcements: "안내 사항을 메일로 받겠습니다" # {change}
    sign_in_to_continue: "계속하려면 로그인하거나 새로 가입하세요."
#    teacher_email_announcements: "Keep me updated on new teacher resources, curriculum, and courses!"
    ...
    connected_gplus_header: "성공적으로 Google+에 연결되었습니다."
...
#    finished_hoc: "I'm finished with my Hour of Code"
    get_certificate: "자격증을 받으세요!"
    level_complete: "레벨 성공"
    completed_level: "완료된 레벨:"
    course: "코스:"
    done: "완료"
    next_level: "다음 레벨"
    challenge_unlocked: "도전 잠금해제"
    start_challenge: "도전 시작하기"
    next_game: "다음 게임"
    languages: "언어들"
